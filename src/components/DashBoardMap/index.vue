      ...
      async setMapInfo() {
        ...
        if (this.searchCity[0] === '全部') {
          ...
          if (this.searchCity.length === 3 && this.searchCity[2] !== '全部') {
            console.log('search1');
            data = (await getDeviceByCity(this.searchCity[0], this.searchCity[1], this.searchCity[2])).data.d;
          } else if ((this.searchCity.length === 2 && this.searchCity[1] !== '全部') || (this.searchCity.length === 3 && this.searchCity[2] === '全部')) {
            console.log('search2');
            data = (await getDeviceByCity(this.searchCity[0], this.searchCity[1])).data.d;
          } else if ((this.searchCity.length === 1) || (this.searchCity.length === 2 && this.searchCity[1] === '全部')) {
            console.log('search3');
